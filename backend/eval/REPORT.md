# Bible RAG Retrieval Evaluation Report
...
| Variant | Precision@10 | Recall@10 | MRR | NDCG@10 | Avg Latency (ms) |
|---|---|---|---|---|---|
| BM25 (full-text only) | 0.045 | 0.035 | 0.049 | 0.030 | 393 |
| Semantic (vector only) | 0.073 | 0.156 | 0.289 | 0.155 | 1169 |
| Hybrid RRF (vector + BM25) | 0.070 | 0.153 | 0.273 | 0.147 | 950 |
| Hybrid RRF + Reranker | 0.092 | 0.198 | 0.310 | 0.185 | 2635 |
| Hybrid RRF + Reranker + Query Expansion | 0.098 | 0.210 | 0.315 | 0.192 | 8215 |

## Category: cross_lingual

| Variant | Precision@10 | Recall@10 | MRR | NDCG@10 | Avg Latency (ms) |
|---|---|---|---|---|---|
| BM25 (full-text only) | 0.000 | 0.000 | 0.000 | 0.000 | 188 |
| Semantic (vector only) | 0.070 | 0.137 | 0.126 | 0.091 | 807 |
| Hybrid RRF (vector + BM25) | 0.070 | 0.137 | 0.111 | 0.087 | 918 |
| Hybrid RRF + Reranker | 0.110 | 0.227 | 0.320 | 0.197 | 2230 |
| Hybrid RRF + Reranker + Query Expansion | 0.120 | 0.260 | 0.331 | 0.211 | 8453 |

## Category: korean

| Variant | Precision@10 | Recall@10 | MRR | NDCG@10 | Avg Latency (ms) |
|---|---|---|---|---|---|
| BM25 (full-text only) | 0.000 | 0.000 | 0.000 | 0.000 | 210 |
| Semantic (vector only) | 0.040 | 0.120 | 0.333 | 0.149 | 840 |
| Hybrid RRF (vector + BM25) | 0.040 | 0.120 | 0.333 | 0.149 | 928 |
| Hybrid RRF + Reranker | 0.050 | 0.140 | 0.245 | 0.138 | 2445 |
| Hybrid RRF + Reranker + Query Expansion | 0.050 | 0.140 | 0.240 | 0.137 | 8628 |

## Category: narrative

| Variant | Precision@10 | Recall@10 | MRR | NDCG@10 | Avg Latency (ms) |
|---|---|---|---|---|---|
| BM25 (full-text only) | 0.042 | 0.021 | 0.062 | 0.024 | 168 |
| Semantic (vector only) | 0.138 | 0.237 | 0.492 | 0.248 | 1404 |
| Hybrid RRF (vector + BM25) | 0.138 | 0.237 | 0.398 | 0.228 | 1035 |
| Hybrid RRF + Reranker | 0.188 | 0.318 | 0.476 | 0.303 | 2508 |
| Hybrid RRF + Reranker + Query Expansion | 0.200 | 0.336 | 0.483 | 0.318 | 7914 |

## Category: thematic

| Variant | Precision@10 | Recall@10 | MRR | NDCG@10 | Avg Latency (ms) |
|---|---|---|---|---|---|
| BM25 (full-text only) | 0.121 | 0.102 | 0.123 | 0.083 | 865 |
| Semantic (vector only) | 0.058 | 0.147 | 0.253 | 0.151 | 1587 |
| Hybrid RRF (vector + BM25) | 0.050 | 0.137 | 0.276 | 0.140 | 939 |
| Hybrid RRF + Reranker | 0.050 | 0.142 | 0.245 | 0.135 | 3216 |
| Hybrid RRF + Reranker + Query Expansion | 0.050 | 0.142 | 0.252 | 0.137 | 7873 |
