    ...
    <main className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {!results && !isLoading && !error && (
          <div className="max-w-4xl mx-auto text-center py-12">
            ...
            <h2 className="text-xl font-medium text-gray-600 mb-2">Search the Bible</h2>
            ...
            <div className="mt-12 grid md:grid-cols-3 gap-6 text-left">
              <div className="p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <h3 className="font-semibold text-gray-800 mb-2">Semantic Search</h3>
              ...
              <div className="p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <h3 className="font-semibold text-gray-800 mb-2">Multilingual</h3>
                <p className="text-sm text-gray-600">
      ...
      <footer className="border-t border-gray-200 mt-12 py-8">
        <div className="container mx-auto px-4 text-center text-gray-500 text-sm">
          <p>Bible RAG - Multilingual Bible Study Platform</p>
          <p className="mt-1">Powered by semantic search and AI</p>
        </div>
      </footer>
    </main>
  );
